...
uint16_t UTF2SJIS(spiffs_file fd, uint8_t *utf8) {
  ...
  if(utf8[0]>=0xC2 && utf8[0]<=0xD1){
	offset = ((utf8[0]*256 + utf8[1])-0xC2A2)*2 + 0xB0;
  }else if(utf8[0]==0xE2 && utf8[1]>=0x80){
	offset = (UTF8uint-0xE28090)*2 + 0x1EEC;
  }else if(utf8[0]==0xE3 && utf8[1]>=0x80){
	offset = (UTF8uint-0xE38080)*2 + 0x9DCC;
  }else if(utf8[0]==0xE4 && utf8[1]>=0x80){
	offset = (UTF8uint-0xE4B880)*2 + 0x11CCC;
  }else if(utf8[0]==0xE5 && utf8[1]>=0x80){
	offset = (UTF8uint-0xE58085)*2 + 0x12BCC;
  }else if(utf8[0]==0xE6 && utf8[1]>=0x80){
	offset = (UTF8uint-0xE6808E)*2 + 0x1AAC2;
  }else if(utf8[0]==0xE7 && utf8[1]>=0x80){
	offset = (UTF8uint-0xE78081)*2 + 0x229A6;
  }else if(utf8[0]==0xE8 && utf8[1]>=0x80){
	offset = (UTF8uint-0xE88080)*2 + 0x2A8A4;
  }else if(utf8[0]==0xE9 && utf8[1]>=0x80){
	offset = (UTF8uint-0xE98080)*2 + 0x327A4;
  }else if(utf8[0]>=0xEF && utf8[1]>=0xBC){
	offset = (UTF8uint-0xEFBC81)*2 + 0x3A6A4;
